---
name: git-workflows
description: "Advanced git operations beyond add/commit/push. Rebasing, bisecting bugs, worktrees for parallel development, reflog recovery, subtrees/submodules, merge conflict resolution, cherry-picking, and monorepo management. Use when asked to 'rebase', 'bisect', 'use worktrees', 'recover with reflog', 'manage submodules', or 'resolve merge conflicts'. NOT for: basic git commands (just use exec), or GitHub API operations (use github skill)."
