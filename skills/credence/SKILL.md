---
name: credence
description: "Check any MCP server or AI tool against the Credence trust registry before installing. Scores security, provenance, and behavioral risk on a 0-100 scale. Use when evaluating a new MCP server, checking tool trustworthiness, or vetting AI integrations. NOT for: scanning skill files (use heimdall), or runtime monitoring (use skillfence)."
user-invocable: true
