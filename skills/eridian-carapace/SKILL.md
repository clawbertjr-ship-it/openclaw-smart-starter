...
description: "Agent security hardening and prompt injection defense for OpenClaw. Protects against prompt injection, data exfiltration, credential theft, and unauthorized operations. Includes security audit checklist, 8 attack vector defenses, credential protection, and approval flows. Use when setting up agent security, performing security audits, hardening configs, or defending against attacks. NOT for: scanning skills before install (use heimdall), or web app security (use VibeSec-Skill)."
---
# Eridian Carapace
