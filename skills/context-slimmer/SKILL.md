...
description: "Audit and slim down always-loaded context files (AGENTS.md, TOOLS.md, USER.md, MEMORY.md, HEARTBEAT.md, SOUL.md, IDENTITY.md). Measures token cost and identifies what to move, remove, or compress. Use when asked to 'reduce token usage', 'audit context', 'optimize context window', or 'slim down workspace'. NOT for: memory consolidation (use memory_maintenance.py), or general file cleanup."
---
# Context Slimmer
